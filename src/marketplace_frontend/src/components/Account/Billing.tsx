                    ...
                    <div className="shadow sm:overflow-hidden sm:rounded-md">
                        ...
                        <div className="mt-6 grid grid-cols-4 gap-6">
                            ...
                            <input
                                ...
                                className="mt-1 block w-full rounded-md border bg-white border-gray-300 py-2 px-3 shadow-sm focus:border-primary focus:outline-none focus:ring-primary sm:text-sm"
                            />
                            </div>
                        </div>
                        </div>
                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                {payments.map((payment) => (
                                    ...
                                    <td className="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                                        <a href={payment.href} className="text-primary hover:text-secondary">
                                        View receipt
                                        </a>
                                    </td>
                                    </tr>
