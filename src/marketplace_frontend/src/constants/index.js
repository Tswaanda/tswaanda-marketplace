	...
	orders: [
		{
			...
			a: "To place an order, simply click on the product you want to purchase, select the quantity and click on the “Add to Tswaanda” button. You can then proceed to checkout or continue shopping."
		},
		{
			q: "How do I know if my order was successful?",
			a: "You will receive an email confirmation with your order number and details of your purchase."
		},
		{
			q: "Can I cancel my order?",
			a: "Yes, you can cancel your order within 24 hours of placing it. Please contact us at contact@tswaanda.com with your order number and reason for cancellation."
		},
	],
	disputes: [
		{
			q: "How do I report an issue?",
			a: "Report any issues via our online customer support on our website at the bottom right corner, including your order number and a detailed description of the problem. You can also send us an email at contact@tswaanda.com"
		},
		{
			q: "What is Tswaanda's response time to queries?",
			a: "We aim to investigate and respond to all queries within 24 hours, keeping you informed throughout the process."
		},
		{
			q: "What resolution options does Tswaanda offer?",
			a: "Depending on the issue, we offer solutions such as refunds, replacements, or credits. Each case is handled individually to ensure fairness."
		}
