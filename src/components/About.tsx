import { FarmerImg } from "../assets";

const About = () => {
  return (
    <section className="">
      <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        <img className="m-0 w-full rounded-xl" src={FarmerImg} alt="farmer" />
        <div className="mt-4 md:mt-0">
          ...
          <a
            href="#"
            className="inline-flex items-center text-primary bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary font-medium rounded-lg text-sm px-5 py-2.5 text-center"
          >
            Get started
            <svg
